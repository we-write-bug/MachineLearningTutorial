...
public class CustomHorizontalProgresWithNum extends ProgressBar{
    ...
    protected static final int DEAFUALT_PROGRESS_VIEW_WIDTH = 500;//进度条默认宽度
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        int textWidth = (int) mPaint.measureText((int)(getProgress()/6.0)+"%");//The width of the text
        ...
        canvas.drawText((int)(getProgress()/6.0)+"%",progressX + HorizontalProgresTextOffset/2,getPaddingTop() + y,mPaint);
        //绘制未做走完的进度
